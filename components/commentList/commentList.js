...
Component({
  ...
  methods: {
    ...
    async showList(e) {
      ...
      // console.log(musicId);
      let floorComment = await musicRequest.get('/comment/floor', { parentCommentId: commentId, id: this.data.musicId, limit: 10, type: resourceTypeNum })
    ...
    async reachFloorBottom() {
      ...
      let result = await musicRequest.get('/comment/floor', { parentCommentId: commentId, id: this.data.musicId, limit: 10, type: resourceTypeNum, time: floorCommentTime })
    ...
    async getCommentList(id, page) {
      ...
      let commentData = await musicRequest.get('/comment/new', { id, pageSize: 10, pageNo: page, sortType: 2, type: resourceTypeNum });
